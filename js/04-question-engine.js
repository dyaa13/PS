...
const PROBLEM_BANKS = {
  ...
  minimumMaximum: psGenMinimumMaximum,
  countingCodes: psGenCountingCodes,
  systematicCounting: psGenSystematicCounting,
  informationSufficiency: psGenInformationSufficiency,
